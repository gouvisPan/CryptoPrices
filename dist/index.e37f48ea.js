...
var _cryptoListView = require("./views/cryptoListView");
var _cryptoListViewDefault = parcelHelpers.interopDefault(_cryptoListView);
...
const loadCoinDetails = function(id) {
    this.state.activeCoin = this.state.search.cryptoInfo.find((coin)=>coin.id === id);
};
const getCryptoPage = function(page = state.search.currentPage) {
...
parcelHelpers.export(exports, "filterCryptos", ()=>filterCryptos);
var _config = require("./config");
...
const filterCryptos = function(array, currency) {
    const myCryptos = array.filter((crypto)=>(0, _config.CRYPTOS_OF_INTEREST).some((symbol)=>symbol === crypto.symbol.slice(0, 3) && crypto.symbol.slice(-currency.length) === currency && crypto.symbol.length < 8));
    return myCryptos;
};
...
class CryptoListView extends (0, _viewDefault.default) {
...
},{}],"bES77":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
class PaginationView extends (0, _viewDefault.default) {
    ...
    _generateMarkup() {
        ...
        const totalPages = Math.ceil(this._data.cryptoInfo.length / this._data.resultsPerPage);
        console.log(curPage);
