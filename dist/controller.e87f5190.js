...
exports.getJSON = exports.filterCryptos = void 0;
...
var filterCryptos = function filterCryptos(array, currency) {
  var myCryptos = array.filter(function (crypto) {
    return _config.CRYPTOS_OF_INTEREST.some(function (symbol) {
      return symbol === crypto.symbol.slice(0, 3) && crypto.symbol.slice(-currency.length) === currency && crypto.symbol.length < 8;
    });
  });
  return myCryptos;
};

exports.filterCryptos = filterCryptos;
...
var fetchCryptoInfo = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _helpers.getJSON)("".concat(_config.API_BASE_URL).concat(_config.API_100_LARGEST_URL));
...
var getCryptoPage = function getCryptoPage() {
  var page = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : state.search.currentPage;
  state.search.currentPage = page;
  var first = (page - 1) * state.search.resultsPerPage;
  var last = page * state.search.resultsPerPage;
...
},{"../../img/icons.svg":"src/img/icons.svg"}],"src/js/views/cryptoListView.js":[function(require,module,exports) {
"use strict";
...
var CryptoListView = /*#__PURE__*/function (_View) {
  _inherits(CryptoListView, _View);

  var _super = _createSuper(CryptoListView);

  function CryptoListView() {
    var _this;

    _classCallCheck(this, CryptoListView);
    ...
    _defineProperty(_assertThisInitialized(_this), "_errorMessage", "Could not match any coin/token to your search... Please try with a different query!");
...
var DetailView = /*#__PURE__*/function (_View) {
  ...
  _createClass(DetailView, [{
    key: "loadCoinDetails",
    value: function loadCoinDetails(data) {
      console.log(data);
      this._data = data;
    }
  }, {
    key: "addHandlerDetails",
    value: function addHandlerDetails(handler) {
...
var PaginationView = /*#__PURE__*/function (_View) {
  ...
  _createClass(PaginationView, [{
    key: "addHandlerPageChange",
    value: function addHandlerPageChange(handler) {
...
var _cryptoListView = _interopRequireDefault(require("./views/cryptoListView"));
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _cryptoListView.default.renderSpinner();

            _context.next = 4;
            return model.fetchCryptoInfo();

          case 4:
            _cryptoListView.default.render(model.getCryptoPage());
...
var controlDetails = function controlDetails() {
...
var goToPage = function goToPage(page) {
  _cryptoListView.default.render(model.getCryptoPage(page));
